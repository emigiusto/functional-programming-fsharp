...
//Exercise 1. Extend the expression language and monadic evaluators with single-argument 
//functions such as ABS(e1) which evaluates e1 and produces its absolute value.  
...
// monad definitions (OptionBuilder, SetBuilder, TraceBuilder) at all.  
//Abstract out the action of ABS on its argument in new auxiliary functions opEvalOpt1, 
//opEvalSet1 and opEvalTrace1 similar to the existing functions opEvalOpt, opEvalSet and opEvalTrace for two-argument primitives.  
...
let expr13 = Prim3("+", CstI(7), Prim("choose", Prim1("ABS", CstI(-9)), CstI(10)), CstI(10))
