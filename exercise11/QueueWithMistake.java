...
//  All nodes that were removed from the queue still pointed to the next node after dequeue, that means
//  the garbage collector was not considering those as "dead nodes" as they have a pointer to a live object in memory
//  resulting in them accumulating in memory in each iteration
//----------------------------SOLUTION -----------------------------------
